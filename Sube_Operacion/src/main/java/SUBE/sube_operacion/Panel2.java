...
public class Panel2 extends JFrame implements ActionListener, ChangeListener{
...
//PARA RECUPERAR UNA VARIABLE DE OTRA CLASE
Panel1 ventanaCocaCola = new Panel1();
...
//ImageIcon nombre = new ImageIcon ("images/coca/cola.png");
label1 = new JLabel();
...
box1 = new JCheckBox("Yo, "+ nombrerecuperado+ ", acepto los terminos");
box1.setBounds(30,460,300,30);
